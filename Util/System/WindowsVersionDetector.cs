...
namespace Util
{
    ...
    internal static class WindowsVersionDetector
    {
        /// <summary>
        /// <para>
    ...
    /// <summary>
    /// 用于Api自定义返回的异常信息，有时需要特殊处理返回的Message的
    /// </summary>
    public class PrerequisiteSoftwareValidationException : Exception
    {
        public PrerequisiteSoftwareValidationException(string msg)
            : base(msg)
        {
        }

        public PrerequisiteSoftwareValidationException(string msg, Exception ex)
